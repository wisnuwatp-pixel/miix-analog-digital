  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <button
          onClick={() => navigate("/")}
          className="mt-8 rounded-md border-2 border-miix-coffee bg-miix-coffee px-6 py-3 text-xs font-bold uppercase tracking-wider text-miix-milk transition-all hover:bg-miix-cyan hover:text-miix-coffee hover:border-miix-cyan hover:shadow-[4px_4px_0px_#2a1810]"
        >
          Return Home
        </button>
      </div>
